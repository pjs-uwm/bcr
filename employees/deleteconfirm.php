<?php
session_start();
$page_title = 'Delete Employee Confirmation';
...
if (!isset($_SESSION['email'])) {
	...
	if ($num > 0) { // If it ran OK, display all the records.
		...
		echo "Employee to Delete : $id " . $row['first_name'] . " " . $row['last_name'] . "<p>";

		echo "Are you sure that you want to delete this Employee?<br>";
		echo "<a href=delete.php?id=" . $id . ">YES</a> 
			<a href=index.php>NO</a>";
	} else { // If it did not run OK.
		echo '<p>There is no such Employee. Please check value and try again.</p>';
	}

<?php
session_start();
$page_title = 'Delete Rental Category Confirmation';
...
if (!isset($_SESSION['email'])) {
	...
	if ($num > 0) { // If it ran OK, display all the records.
		...
		echo "Rental Category to Delete : " . $row['rental_category'] . "<p>";

		echo "Are you sure that you want to delete this rental category?<br>";

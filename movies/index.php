...
if (!isset($_SESSION['email'])){
	...
	log_event($_SESSION['user_id'], "Viewed Movies List");
	echo ("<center>"); 
	echo ("<h3>Movies</h3><p>");
	echo ("<a href=add.php>Add Movie</a><p>"); 
	...
	<th>Title (Year)</th><th>*</th><th>*</th><th>*</th></tr>"; 

	//Fetch and print all the records...
	while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
		echo "<tr><td>".$row['title']." (" .$row['year_of_release'].")</td>"; 	 
		echo "<td><a href=deleteconfirm.php?id=".$row['movie_id'].">Delete</a></td>"; 
		echo "<td><a href=update.php?id=".$row['movie_id'].">Update</a></td>"; 
		echo "<td><a href=movieroles?id=".$row['movie_id'].">Credits</a></td></tr>"; 

<?php
session_start();
$page_title = 'Delete Actor Entity Confirmation';
...
if (!isset($_SESSION['email'])) {
	...
	if ($num > 0) { // If it ran OK, display all the records.
		...
		echo "Actor Entity to Delete : " . $row['first_name'] . " " . $row['last_name'] . "<p>";

		echo "Are you sure that you want to delete this Actor Entity?<br>";
